...
export declare class FirestoreDataProviderService implements DataProvider {
    ...
    createEntity<T extends Entity<string>>(collectionPath: string, entityTypeKey: string, entityData: Omit<T, 'id' | 'typeKey'>): Observable<T | undefined>;
    updateEntity<T extends Entity<string>>(path: string, entityId: string, entityData: Partial<Omit<T, "id" | "typeKey">>): Observable<T | undefined>;
    ...
    private transformEntityDataIntoEntity;
