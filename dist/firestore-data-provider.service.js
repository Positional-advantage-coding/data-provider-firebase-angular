...
class FirestoreDataProviderService {
    ...
    updateEntity(path, entityId, entityData) {
        return (0, rxjs_1.defer)(() => (0, rxjs_1.from)((0, firestore_1.updateDoc)((0, firestore_1.doc)(this.firestore, `${path}/${entityId}`), entityData)).pipe((0, operators_1.map)((plainObject) => this.convertIntoEntity(plainObject)), (0, rxjs_1.catchError)(() => (0, rxjs_1.of)(undefined))));
    }
